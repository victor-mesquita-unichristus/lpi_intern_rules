...
### S2-C03 — Refatorar casos de uso e contratos de TCE no backend e preparar compatibilidade com `ADDENDUM`

- Tipo: Back-end
- História: `S2-US-02`
- Escopo:
  - ajustar criação de TCE para `Internship` + termo inicial
  - manter a estrutura compatível com criação futura de termos `ADDENDUM`, sem entregar o fluxo operacional de aditivo
