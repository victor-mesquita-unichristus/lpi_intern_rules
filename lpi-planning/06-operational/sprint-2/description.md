...
Nesta sprint, a entrega deve permanecer compatível com `ADDENDUM`, mas sem implementar o fluxo operacional de aditivo nem recolocar `AgentIntegrator` em escopo.
